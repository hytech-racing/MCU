...
// Steering parameters
const float PRIMARY_STEERING_SENSE_OFFSET = 0.0; // TODO: TUNE THIS. UNITS ARE DEGREES
const int SECONDARY_STEERING_SENSE_LEFTMOST_BOUND = 692;
const int SECONDARY_STEERING_SENSE_RIGHTMOST_BOUND = 3170;
const int SECONDARY_STEERING_SENSE_CENTER = 1874;
const float STEERING_RANGE_DEGREES = 260.0f;
