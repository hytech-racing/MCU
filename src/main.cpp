...
PedalsSystem pedals_system({ACCEL1_PEDAL_MIN, ACCEL2_PEDAL_MIN, ACCEL1_PEDAL_MAX, ACCEL2_PEDAL_MAX, ACCEL1_PEDAL_OOR_MIN, ACCEL2_PEDAL_OOR_MIN, ACCEL1_PEDAL_OOR_MAX, ACCEL2_PEDAL_OOR_MAX, APPS_ACTIVATION_PERCENTAGE, DEFAULT_PEDAL_DEADZONE, DEFAULT_PEDAL_IMPLAUSIBILITY_MARGIN, APPS_ACTIVATION_PERCENTAGE},
                           {BRAKE1_PEDAL_MIN, BRAKE2_PEDAL_MIN, BRAKE1_PEDAL_MAX, BRAKE2_PEDAL_MAX, BRAKE1_PEDAL_OOR_MIN, BRAKE2_PEDAL_OOR_MIN, BRAKE1_PEDAL_OOR_MAX, BRAKE2_PEDAL_OOR_MAX, BRAKE_ACTIVATION_PERCENTAGE, DEFAULT_PEDAL_DEADZONE, DEFAULT_PEDAL_IMPLAUSIBILITY_MARGIN, BRAKE_MECH_THRESH});
