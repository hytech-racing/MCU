...
PedalsSystem pedals_system({ACCEL1_MIN_THRESH, ACCEL2_MAX_THRESH, ACCEL1_MAX_THRESH, ACCEL2_MIN_THRESH, APPS_ACTIVATION_PERCENTAGE},
                           {BRAKE1_MAX_THRESH, BRAKE2_MIN_THRESH, BRAKE1_MIN_THRESH, BRAKE2_MAX_THRESH, BRKAE_ACTIVATION_PERCENTAGE},
                           BRAKE_MECH_THRESH);
