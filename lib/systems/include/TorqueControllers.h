...
private:
    ...
    const uint16_t launch_ready_speed_threshold = 5; // m/s
    ...
    uint32_t time_of_launch = millis();
...
public:
    ...
    void tick(const SysTick_s & tick, const PedalsSystemData_s &pedalsData, uint16_t max_speed);
};
