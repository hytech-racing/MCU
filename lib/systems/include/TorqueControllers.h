...
/// @brief Simple torque controller that only considers pedal inputs and torque limit
class TorqueControllerSimple_10mps : public TorqueController<TC_SAFE_10MPS>
{
private:
    TorqueControllerOutput_s &writeout_;
    float frontTorqueScale_ = 1.0;
...
public:
    ...
    /// @param rearTorqueScale 0 to 2 scale on forward torque to rear wheels. 0 = FWD, 1 = Balanced, 2 = RWD
    /// @param regenTorqueScale same as rearTorqueScale but applies to regen torque split. 0 = All regen torque on the front, 1 = 50/50, 2 = all regen torque on the rear
    TorqueControllerSimple_10mps(TorqueControllerOutput_s &writeout, float rearTorqueScale, float regenTorqueScale, float mps)
        : writeout_(writeout),
          frontTorqueScale_(2.0 - rearTorqueScale),
          rearTorqueScale_(rearTorqueScale),
          frontRegenTorqueScale_(regenTorqueScale),
    ...
    TorqueControllerSimple_10mps(TorqueControllerOutput_s &writeout, float rearTorqueScale, float regenTorqueScale)
        : writeout_(writeout),
          frontTorqueScale_(2.0 - rearTorqueScale),
          rearTorqueScale_(rearTorqueScale),
          frontRegenTorqueScale_(regenTorqueScale),
          rearRegenTorqueScale_(1.0 - regenTorqueScale),
          tc_rpm_(10.0 * METERS_PER_SECOND_TO_RPM)
    {
        writeout_.command = TC_COMMAND_NO_TORQUE;
        writeout_.ready = true;
    }
    TorqueControllerSimple_10mps(TorqueControllerOutput_s &writeout) : TorqueControllerSimple_10mps(writeout, 1.0, 1.0) {}

    void tick(const SysTick_s &tick, const PedalsSystemData_s &pedalsData, float torqueLimit);
};

/// @brief Simple torque controller that only considers pedal inputs and torque limit
class TorqueControllerSimple_15mps : public TorqueController<TC_SAFE_15MPS>
{
private:
    TorqueControllerOutput_s &writeout_;
    float frontTorqueScale_ = 1.0;
...
public:
    ...
    /// @param rearTorqueScale 0 to 2 scale on forward torque to rear wheels. 0 = FWD, 1 = Balanced, 2 = RWD
    /// @param regenTorqueScale same as rearTorqueScale but applies to regen torque split. 0 = All regen torque on the front, 1 = 50/50, 2 = all regen torque on the rear
    TorqueControllerSimple_15mps(TorqueControllerOutput_s &writeout, float rearTorqueScale, float regenTorqueScale, float mps)
        : writeout_(writeout),
          frontTorqueScale_(2.0 - rearTorqueScale),
          rearTorqueScale_(rearTorqueScale),
          frontRegenTorqueScale_(regenTorqueScale),
    ...
    TorqueControllerSimple_15mps(TorqueControllerOutput_s &writeout, float rearTorqueScale, float regenTorqueScale)
        : writeout_(writeout),
          frontTorqueScale_(2.0 - rearTorqueScale),
          rearTorqueScale_(rearTorqueScale),
          frontRegenTorqueScale_(regenTorqueScale),
          rearRegenTorqueScale_(1.0 - regenTorqueScale),
          tc_rpm_(15.0 * METERS_PER_SECOND_TO_RPM)
    {
        writeout_.command = TC_COMMAND_NO_TORQUE;
        writeout_.ready = true;
    }
    TorqueControllerSimple_15mps(TorqueControllerOutput_s &writeout) : TorqueControllerSimple_15mps(writeout, 1.0, 1.0) {}

    void tick(const SysTick_s &tick, const PedalsSystemData_s &pedalsData, float torqueLimit);
};

/// @brief Simple torque controller that only considers pedal inputs and torque limit
class TorqueControllerSimple_20mps : public TorqueController<TC_SAFE_20MPS>
{
private:
    TorqueControllerOutput_s &writeout_;
    float frontTorqueScale_ = 1.0;
...
public:
    ...
    /// @param rearTorqueScale 0 to 2 scale on forward torque to rear wheels. 0 = FWD, 1 = Balanced, 2 = RWD
    /// @param regenTorqueScale same as rearTorqueScale but applies to regen torque split. 0 = All regen torque on the front, 1 = 50/50, 2 = all regen torque on the rear
    TorqueControllerSimple_20mps(TorqueControllerOutput_s &writeout, float rearTorqueScale, float regenTorqueScale, float mps)
        : writeout_(writeout),
          frontTorqueScale_(2.0 - rearTorqueScale),
          rearTorqueScale_(rearTorqueScale),
          frontRegenTorqueScale_(regenTorqueScale),
    ...
    TorqueControllerSimple_20mps(TorqueControllerOutput_s &writeout, float rearTorqueScale, float regenTorqueScale)
        : writeout_(writeout),
          frontTorqueScale_(2.0 - rearTorqueScale),
          rearTorqueScale_(rearTorqueScale),
          frontRegenTorqueScale_(regenTorqueScale),
          rearRegenTorqueScale_(1.0 - regenTorqueScale),
          tc_rpm_(20.0 * METERS_PER_SECOND_TO_RPM)
    {
        writeout_.command = TC_COMMAND_NO_TORQUE;
        writeout_.ready = true;
    }
    TorqueControllerSimple_20mps(TorqueControllerOutput_s &writeout) : TorqueControllerSimple_20mps(writeout, 1.0, 1.0) {}
