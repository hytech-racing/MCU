...
private:
    ...
    CASESystem torqueControllerCASE_;
    ...
    //maps the torque mode to the torque limit values
    ...
    // maps the current TCMUX mode to each of the controller references
    ...
    void init_controller_map(){
        ...
        controllerMap_[TorqueController_e::TC_CASE_SYSTEM] = torqueControllerCASE_;
    }
