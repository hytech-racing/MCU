...
static rtwCAPI_Signals rtBlockSignals[]{
  ...
  { 0, 19, TARGET_STRING("TRACTION_CONTROL/If Action Subsystem"),
    TARGET_STRING(""), 8, 0, 0, 0, 0 },

  { 1, 19, TARGET_STRING("TRACTION_CONTROL/If Action Subsystem"),
    TARGET_STRING("adjusted_TCS_PID_Output"), 8, 0, 0, 0, 0 },

  { 2, 19, TARGET_STRING("TRACTION_CONTROL/If Action Subsystem"),
    TARGET_STRING(""), 8, 0, 0, 0, 0 },

  { 3, 19, TARGET_STRING("TRACTION_CONTROL/If Action Subsystem"),
    TARGET_STRING("adjusted_TCS_PID_Output"), 8, 0, 0, 0, 0 },

  { 4, 19, TARGET_STRING("TRACTION_CONTROL/If Action Subsystem"),
    TARGET_STRING(""), 8, 0, 0, 0, 0 },

  { 5, 19, TARGET_STRING("TRACTION_CONTROL/If Action Subsystem"),
    TARGET_STRING("adjusted_TCS_PID_Output"), 8, 0, 0, 0, 0 },

  { 6, 19, TARGET_STRING("TRACTION_CONTROL/If Action Subsystem"),
    TARGET_STRING(""), 8, 0, 0, 0, 0 },

  { 7, 19, TARGET_STRING("TRACTION_CONTROL/If Action Subsystem"),
    TARGET_STRING("adjusted_TCS_PID_Output"), 8, 0, 0, 0, 0 },

  { 8, 19, TARGET_STRING("TRACTION_CONTROL/If Action Subsystem/MATLAB Function"),
    TARGET_STRING(""), 0, 0, 0, 0, 0 },

  { 9, 19, TARGET_STRING("TRACTION_CONTROL/If Action Subsystem/MATLAB Function1"),
    TARGET_STRING(""), 0, 0, 0, 0, 0 },

  { 10, 19, TARGET_STRING(
    "TRACTION_CONTROL/If Action Subsystem/MATLAB Function2"),
    TARGET_STRING(""), 0, 0, 0, 0, 0 },

  { 11, 19, TARGET_STRING(
    "TRACTION_CONTROL/If Action Subsystem/MATLAB Function3"),
    TARGET_STRING(""), 0, 0, 0, 0, 0 },

  { 12, 19, TARGET_STRING("TRACTION_CONTROL/If Action Subsystem/Switch"),
    TARGET_STRING(""), 0, 0, 0, 0, 0 },

  { 13, 19, TARGET_STRING("TRACTION_CONTROL/If Action Subsystem/Switch1"),
    TARGET_STRING(""), 0, 0, 0, 0, 0 },

  { 14, 19, TARGET_STRING("TRACTION_CONTROL/If Action Subsystem/Switch3"),
    TARGET_STRING(""), 0, 0, 0, 0, 0 },

  { 15, 19, TARGET_STRING("TRACTION_CONTROL/If Action Subsystem/Switch6"),
    TARGET_STRING(""), 0, 0, 0, 0, 0 },
  ...
  TRACTION_CONTROL::B_TRACTION_CONTROL_T *TRACTION_CONTROL_B)
{
  ...
  dataAddr[1] = (void*) (&TRACTION_CONTROL_B->adjusted_TCS_PID_Output_e);
  dataAddr[2] = (void*) (&TRACTION_CONTROL_B->Switch1);
  dataAddr[3] = (void*) (&TRACTION_CONTROL_B->adjusted_TCS_PID_Output_l);
  dataAddr[4] = (void*) (&TRACTION_CONTROL_B->Switch3);
  dataAddr[5] = (void*) (&TRACTION_CONTROL_B->adjusted_TCS_PID_Output_c);
  dataAddr[6] = (void*) (&TRACTION_CONTROL_B->Switch6);
  dataAddr[7] = (void*) (&TRACTION_CONTROL_B->adjusted_TCS_PID_Output);
  dataAddr[8] = (void*) (&TRACTION_CONTROL_B->adjusted_TCS_PID_Output_e);
  dataAddr[9] = (void*) (&TRACTION_CONTROL_B->adjusted_TCS_PID_Output_l);
  dataAddr[10] = (void*) (&TRACTION_CONTROL_B->adjusted_TCS_PID_Output_c);
  dataAddr[11] = (void*) (&TRACTION_CONTROL_B->adjusted_TCS_PID_Output);
  dataAddr[12] = (void*) (&TRACTION_CONTROL_B->Switch);
  dataAddr[13] = (void*) (&TRACTION_CONTROL_B->Switch1);
  dataAddr[14] = (void*) (&TRACTION_CONTROL_B->Switch3);
  dataAddr[15] = (void*) (&TRACTION_CONTROL_B->Switch6);
}
