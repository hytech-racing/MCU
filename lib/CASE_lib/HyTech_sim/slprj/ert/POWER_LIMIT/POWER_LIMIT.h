...
class POWER_LIMIT final
{
 ...
 public:
  ...
  // model step function
  void step(const real_T *rtu_CurrentPowerkW, const real_T *rtu_TorqueFL, const
            real_T *rtu_TorqueFR, const real_T *rtu_TorqueRL, const real_T
            *rtu_TorqueRR, const real_T *rtu_WheelOmegaFLrads, const real_T
            *rtu_WheelOmegaFRrads, const real_T *rtu_WheelOmegaRLrads, const
            real_T *rtu_WheelOmegaRRrads, const boolean_T *rtu_usePowerLimit,
            const boolean_T *rtu_usePIDPowerLimit, real_T *rty_PLTorqueFL,
            real_T *rty_PLTorqueFR, real_T *rty_PLTorqueRL, real_T
            *rty_PLTorqueRR, real_T *rty_PowerLimStatus, real_T
            *rty_PowerLimErrorkW, real_T *rty_PowerLimTorqueAdjustment, real_T
            *rty_CornerPowerFLkW, real_T *rty_CornerPowerFRkW, real_T
