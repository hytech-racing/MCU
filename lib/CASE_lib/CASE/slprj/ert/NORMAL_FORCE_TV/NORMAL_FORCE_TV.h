...
class NORMAL_FORCE_TV final
{
 ...
 public:
  ...
  void step(const boolean_T *rtu_useNormalForce, const real_T *rtu_FZ_FL, const
            ...
            const boolean_T *rtu_usePIDTVBool, real_T *rty_FL_torque_out, real_T
            *rty_FR_torque_out, real_T *rty_RL_torque_out, real_T
            *rty_RR_torque_out, real_T *rty_Normal_Percent_FL, real_T
...
//  '<S1>'   : 'NORMAL_FORCE_TV/MATLAB Function'
