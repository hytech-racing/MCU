...
void LAUNCH_CONTROL_InitializeDataMapInfo(LAUNCH_CONTROL::
  RT_MODEL_LAUNCH_CONTROL_T *const LAUNCH_CONTROL_M)
{
  // Set C-API version
  rtwCAPI_SetVersion(LAUNCH_CONTROL_M->DataMapInfo.mmi, 1);

  // Cache static C-API data into the Real-time Model Data structure
  rtwCAPI_SetStaticMap(LAUNCH_CONTROL_M->DataMapInfo.mmi, &mmiStatic);

  // Cache static C-API logging data into the Real-time Model Data structure
  rtwCAPI_SetLoggingStaticMap(LAUNCH_CONTROL_M->DataMapInfo.mmi, (nullptr));

  // Set Instance specific path
  rtwCAPI_SetPath(LAUNCH_CONTROL_M->DataMapInfo.mmi, (nullptr));
  rtwCAPI_SetFullPath(LAUNCH_CONTROL_M->DataMapInfo.mmi, (nullptr));

  // Cache the instance C-API logging pointer
  rtwCAPI_SetInstanceLoggingInfo(LAUNCH_CONTROL_M->DataMapInfo.mmi, (nullptr));

  // Set reference to submodels
  rtwCAPI_SetChildMMIArray(LAUNCH_CONTROL_M->DataMapInfo.mmi, (nullptr));
  rtwCAPI_SetChildMMIArrayLen(LAUNCH_CONTROL_M->DataMapInfo.mmi, 0);
}
