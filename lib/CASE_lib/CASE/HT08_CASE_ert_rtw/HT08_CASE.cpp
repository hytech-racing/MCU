...
void HT08_CASE::step()
{
  ...
  Vehicle_MathMDLOBJ3.step(&HT08_CASE_U.Vx_B, &HT08_CASE_U.Vy_B,
    ...
    &HT08_CASE_B.BetaDeg, &HT08_CASE_B.AlphaFLDeg, &HT08_CASE_B.AlphaFRDeg,
    &HT08_CASE_B.AlphaRLDeg, &HT08_CASE_B.AlphaRRDeg,
  ...
  PID_TVMDLOBJ5.step(&HT08_CASE_U.YawRaterads, &HT08_CASE_U.YawPIDConfig[1],
                     ...
                     &HT08_CASE_U.YawPIDConfig[0], &HT08_CASE_U.TorqueAverageNm,
                     &HT08_CASE_U.TorqueAverageNm, &HT08_CASE_U.TorqueAverageNm,
                     &HT08_CASE_U.TorqueAverageNm, &HT08_CASE_U.usePIDTV,
                     &HT08_CASE_B.VehicleMath_o10, &HT08_CASE_U.Vx_B,
                     &HT08_CASE_U.TorqueLimit, &HT08_CASE_B.FRTORQUEPID,
  ...
  ModelMDLOBJ4.step(&HT08_CASE_U.useNormalForce, &HT08_CASE_U.FZFL,
                    ...
                    &HT08_CASE_U.usePIDTV, &HT08_CASE_B.TorqueNormalFL,
                    &HT08_CASE_B.TorqueNormalFR, &HT08_CASE_B.TorqueNormalRL,
                    &HT08_CASE_B.TorqueNormalRR, &HT08_CASE_B.Normal_Percent_FL,
  ...
  //   Inport generated from: '<Root>/TCSThreshold'
  //   Inport generated from: '<Root>/Torque Average [Nm]'
  //   Inport generated from: '<Root>/useLaunch'
  //   Inport generated from: '<Root>/useTractionControl'

  TCSMDLOBJ2.step(&HT08_CASE_U.TorqueAverageNm, &HT08_CASE_U.useTractionControl,
                  &HT08_CASE_U.TCSThreshold, &HT08_CASE_B.TorqueNormalFL,
                  &HT08_CASE_B.TorqueNormalFR, &HT08_CASE_B.TorqueNormalRL,
                  &HT08_CASE_B.TorqueNormalRR, &HT08_CASE_B.SLFL,
  ...
  Power_LimitMDLOBJ1.step(&HT08_CASE_U.CurrentPowerkW, &HT08_CASE_B.TCS_o1,
...

  {
    ...
    //  -----------------------------------------------------------------------
    {
      ...
      {
        real_T result = HT08_CASE_U.TCSThreshold;
