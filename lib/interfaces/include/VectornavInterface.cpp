...
void VNInterface::retrieve_velocity_CAN(CAN_message_t &recvd_msg) {
    VN_VEL_t vel_data;
...
void VNInterface::retrieve_linear_accel_CAN(CAN_message_t &recvd_msg) {
...
void VNInterface::retrieve_uncompLinear_accel_CAN(CAN_message_t &recvd_msg) {
...
void VNInterface::retrieve_ypr_CAN(CAN_message_t &recvd_msg) {
    VN_YPR_t ypr_data;
...
void VNInterface::retrieve_lat_lon_CAN(CAN_message_t &recvd_msg) {
...
void VNInterface::retrieve_gps_time_CAN(CAN_message_t &recvd_msg) {
...
void VNInterface::retrieve_vn_status_CAN(CAN_message_t &recvd_msg) {
...
void VNInterface::retrieve_vn_ecef_pos_xy_CAN(CAN_message_t &recvd_msg) {
...
void VNInterface::retrieve_vn_ecef_pos_z_CAN(CAN_message_t &recvd_msg) {
...
void VNInterface::receive_ang_rates_CAN(CAN_message_t & recvd_msg)
{
 ...
 * @return vector_nav 
 */
vector_nav VNInterface::get_vn_struct() {
    return vn_data; 
}
